					...
					<div class="col-md-12">
						<div class="container-inner">
							<ul>
								...
								<li class="category3"><span>Wishlist</span></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-12 col-lg-9 col-md-9">
						...
						<div class="table-responsive">
							<table class="cart-table">
								...
								<tbody>
									<tr>
										<td>
											<a class="tb-img" href="#"><img alt="" class="img-responsive" src="img/products/wishlist/wish-1.jpg"></a>
										</td>
										<td>
										...
										<td class="text-center">
											<div class="price-box">
												<span class="special-price">$280.00</span>
											</div>
											<form>
						...
						<div class="cartPage-btn">
							<ul>
								<li><a href="#" class="cbtn">Share Wishlist</a></li>
								<li><a href="#" class="cbtn">Add All to Cart</a></li>
								<li><a href="#" class="cbtn">Update Wishlist</a></li>
							</ul>
						</div>
